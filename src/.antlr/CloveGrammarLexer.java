...
public class CloveGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "EQUAL", "NOTEQUAL", "LESST", "GREATERT", 
			"LESSTEQUAL", "GREATERTEQUAL", "MOD", "DIVIDE", "MULTIPLY", "ADD", "SUBTRACT", 
			"AND", "OR", "NOT", "ID", "NUM", "Str", "WS", "COMMENT"
		};
	}
	...
	public CloveGrammarLexer(CharStream input) {
		super(input);
